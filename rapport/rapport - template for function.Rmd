...
affiliation:
  - affsuperscript: 1
    dptuniv: Master "Ecologie des forets tropicales", AgroParistech.
    address: >
      Campus Agronomique,
      97310 Kourou,
      France.
...
Si LaTeX ne parvient pas à trouver de solution pour le retour à la ligne, par exemple parce que du code constitue un bloc insécable trop long, ajouter la commande LaTeX `\break` à l'emplacement du retour à la ligne.
...
Le package _rticle_ fournit des modèles d'articles (PLOS, PNAS, etc.), mais nécessite l'utilisation de commandes LaTeX et ne permet pas le tricot en HTML.
